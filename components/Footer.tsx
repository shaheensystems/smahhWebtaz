...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row md:flex-wrap xl:flex-nowrap  bg-midnight-900 w-full py-10 xl:py-20 px-10 relative'>
      <div className='w-full xl:w-2/5 pb-10 xl:pb-0'>
      ...
      <div className='w-full xl:w-3/5 flex flex-col md:flex-row justify-between xl:justify-around pb-32'>
        {contentIndexes?.map((item, index) => (
          <div key={index}>
            <h4 className="text-2xl text-white pt-10 md:pt-0 pb-4">{item.title}</h4>
